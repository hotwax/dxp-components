...
import { LanguageSwitcher, OmsInstanceNavigator, ProductIdentifier, ShopifyImg, TimeZoneSwitcher } from "./components";
...
export let dxpComponents = {
  install(app: any, options: any) {
    ...
    app.component('TimeZoneSwitcher', TimeZoneSwitcher)
